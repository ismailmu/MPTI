	...
	<body>
									...
									<table class="table table-striped table-bordered table-hover" id="tbl">
										...
										<tbody>
											...
											foreach ($grid as $key => $value) {
												...
												echo "<td>$value->hardware_code</td>";
												...
												$path=base_url();
												echo "<td class='fCtr'><button type='button' onclick=\"gotoEdit('$value->hardware_code')\" class='btn btn-outline btn-primary btn-xs'><i class='fa fa-edit fa-fw'></i>Edit</button></td>";
												echo "</tr>";
		...
		<script>
			...
			function gotoAdd(path) {
				window.location.href = path + 'index.php/hardware/add';
			}
			function gotoEdit(id) {
				window.location.href = '<?php echo base_url(); ?>index.php/hardware/edit/'+id;
			}
		</script>
	</body>
