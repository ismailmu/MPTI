...
<table width="100%" class="tblParent">
	...
	<tr><td>&nbsp;</td><td colspan="4" style="text-align: center"><h2>PERMOHONAN GS<br/>
	...
	<tr>
	  ...
	  <td colspan="3"><table width="100%" border="0">
        <tr>
          ...
          <td width="1">:</td>
          <td><?php echo $grid -> row() -> user_name; ?></td>
        </tr>
        <tr>
          <td>Departement</td>
          <td>:</td>
          <td><?php echo $grid -> row() -> departement; ?></td>
        </tr>
        <tr>
          <td>NIK</td>
          <td>:</td>
          <td><?php echo $grid -> row() -> user_code; ?></td>
        </tr>
      </table></td>
	  <td>&nbsp;</td>
  </tr>
	...
	<tr>
		<td>&nbsp;</td><td>Mengajukan, </td><td>&nbsp;</td><td style="text-align:center">Mengetahui,</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td>(&nbsp;<?php echo $grid -> row() -> admin; ?>&nbsp;)</td><td>&nbsp;</td><td style="text-align:center">(_______________)</td>
		<td>&nbsp;</td>
		<td style="text-align:center">(&nbsp;<?php echo $grid -> row() -> user_name; ?>&nbsp;)</td><td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td><td> Penerima Pekerjaan</td><td>&nbsp;</td><td style="text-align:center">Atasan Pemohon</td>
		<td>&nbsp;</td>
		<td style="text-align:center">Pemohon</td><td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td><td>Analisa : <?php echo $grid -> row() -> analisa; ?></td><td>&nbsp;</td><td>&nbsp;</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td><td>&nbsp;</td>
	</tr>
	<tr>
