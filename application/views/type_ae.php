	...
	<body>
		...
		<div id="wrapper">
			...
			<?php
				...
				if ($flag=="Add") {
					if (isset($dataFrom)) {
						$valCode=$dataFrom['type_code'];
					}
				}else {
					if (isset($dataFrom)) {
						$valCode=$dataFrom['type_code'];
					}else {
						$valCode=$id[0]->type_code;	
					}
				}
				...
				if ($flag=="Add") {
					if (isset($dataFrom)) {
						$valName=$dataFrom['type_name'];
					}
				}else {
					if (isset($dataFrom)) {
						$valName=$dataFrom['type_name'];
					}else {
						$valName=$id[0]->type_name;	
					}
				}
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="panel panel-default">
									<form role="form" id="type_ae" name="type_ae" method="post" action="<?php echo base_url(); ?>index.php/type/<?php echo strtolower($flag); ?>Process">
										<div class="panel-heading">
											<table class="table table-striped">
												...
												<tbody>
													...
													<tr>
														<td>Type Name <span class="valid">*</span></td>
														<td>
		...
		<script>
			$(document).ready(function() {
				$("#reset").click(function() {
					$("#type_ae").validate().resetForm();
				});
				$("#back").click(function() {
					window.location.href='<?php echo base_url(); ?>index.php/type'
				})
