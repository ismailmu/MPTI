	...
	<body>
									...
									<table class="table table-striped table-bordered table-hover" id="tbl">
										...
										<tbody>
											...
											foreach ($grid as $key => $value) {
												...
												$path=base_url();
												echo "<td class='fCtr'><button user='button' onclick=\"gotoEdit('$value->user_code')\" class='btn btn-outline btn-primary btn-xs'><i class='fa fa-edit fa-fw'></i>Edit</button></td>";
												echo "</tr>";
		...
		<script>
			...
			function gotoAdd(path) {
				window.location.href = path + 'index.php/user/add';
			}
			function gotoEdit(id) {
				window.location.href = '<?php echo base_url(); ?>index.php/user/edit/'+id;
			}
		</script>
	</body>
