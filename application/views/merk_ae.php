	...
	<body>
		...
		<div id="wrapper">
			...
			<?php
				...
				if ($flag=="Add") {
					if (isset($dataFrom)) {
						$valCode=$dataFrom['merk_code'];
					}
				}else {
					if (isset($dataFrom)) {
						$valCode=$dataFrom['merk_code'];
					}else {
						$valCode=$id[0]->merk_code;	
					}
				}
				...
				if ($flag=="Add") {
					if (isset($dataFrom)) {
						$valName=$dataFrom['merk_name'];
					}
				}else {
					if (isset($dataFrom)) {
						$valName=$dataFrom['merk_name'];
					}else {
						$valName=$id[0]->merk_name;	
					}
				}
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="panel panel-default">
									<form role="form" id="merk_ae" name="merk_ae" method="post" action="<?php echo base_url(); ?>index.php/merk/<?php echo strtolower($flag); ?>Process">
										<div class="panel-heading">
											<table class="table table-striped">
												...
												<tbody>
													...
													<tr>
														<td>Merk Name <span class="valid">*</span></td>
														<td>
		...
		<script>
			$(document).ready(function() {
				$("#reset").click(function() {
					$("#merk_ae").validate().resetForm();
				});
				$("#back").click(function() {
					window.location.href='<?php echo base_url(); ?>index.php/merk'
				})
